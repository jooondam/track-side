...
![Chase camera on the start line, with the braking into La Source already marked on the line](docs/chase.jpg)
...
The two screenshots above are generated too: `npm run shots` rewrites them from the running
...
/docs/          the validation writeup, and the two screenshots above
```
